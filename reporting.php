...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1><div class="text-center">Advanced Aggregate Report</div></h1>
    </div>
    <br/>
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-8" style="text-align: left">
            <h2 style="color: #245580">Card Wise Transaction</h2>
            <p><strong>Total transaction amount by each type of credit card:</strong></p>
            ...
            <h2 style="color: #245580">Detailed Transaction</h2>
            ...
            <h2 style="color: #245580">Customers Feedback</h2>
            <p><strong>View each customers feedback about our rental service:</strong></p>
            <table class="table table-responsive">
                <thead>
                <tr>
                    <th>Customer Name</th>
                ...
                $query = "SELECT ";
                $query .= "CONCAT(fname, \" \", lname) AS 'Customer Name', ";
                $query .= "experience AS \"Experience\", ";
                $query .= "comments AS 'Feed back' ";
                $query .= "FROM Customer ";
                $query .= "NATURAL JOIN Feedback ";
                $result = $mysqli->query($query);
                while($row = $result->fetch_assoc()){
                    if ($row["Feed back"] != ''){
                        echo "<tr>";
            ...
            <h2 style="color: #245580">Customer List</h2>
            <p><strong>For each type of vehicle, list of all customers who reserving the type of vehicle:</strong></p>
            <table class="table table-responsive">
                <thead>
                <tr>
                    <th>Vehicle Type</th>
