    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            if (adminLogged_in()){
                ...
                echo "<li><a href='reporting.php'><span class='glyphicon glyphicon-user'></span> Dashboard</a></li>";
...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h1><div class="text-center">Contact Us</div></h1>
    </div>
    <br/>
</div>
        ...
        <div class="col-lg-3" id="leftCol">
            <div class="panel panel-default" style="border-color: #122b40">
                ...
                <div class="panel-body" style="text-align: center">
                    <h4>Phone Number:</h4><p>(323)-599-7843</p>
                    <h4>Email:</h4><p>rentalcarservices2@gmail.com</p>
                </div>
            </div>
        </div><!--/left-->
...
<script>
    $(function () {
        ...
        function initMap() {
            ...
            var main_location = new google.maps.LatLng(38.7581, -93.7384);
